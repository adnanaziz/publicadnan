...
public class TestAll {
  ...
  @Before
  public void setup() {
    String timeoutString = System.getenv("TIMEOUT");
  ...
  public void AddOperatorsInString() {
    AddOperatorsInString.main(ARGS);
  }
  ...
  public void AnonymousLetter() {
    String[] letterMagazine = {"ACBD", "SARBCEDEG"};
    AnonymousLetter.main(letterMagazine);
  }
  ...
  public void BuyAndSellStockTwice() {
    BuyAndSellStockTwice.main(ARGS);
  }
  ...
  public void ComputeRandomPermutation() {
    ComputeRandomPermutation.main(ARGS);
  }
  ...
  @Test
  public void DutchNationalFlagTwoPasses() {
    DutchNationalFlagTwoPasses.main(ARGS);
  }

  @Test
  public void DutchNationalFlagSlowInplace() {
    DutchNationalFlagSlowInplace.main(ARGS);
  }
  ...
  @Test public void LongestNondecreasingSubsequence() {
    LongestNondecreasingSubsequence.main(ARGS);
  }
  ...
  @Test
  public void LongestSubarrayKImproved() {
    String[] args = { "100" };
    LongestSubarrayKImproved.main(args);
  }
  ...
  @Test
  public void PrimeSieveBasic() {
    String[] args = { "1000" };
    PrimeSieveBasic.main(args);
  }
  ...
  @Test
  public void SortKIncreasingDecreasingArray() {
    SortKIncreasingDecreasingArray.main(ARGS);
  }
  ...
  @Test public void SudokuCheck() {
    SudokuCheck.main(ARGS);
  }
  ...
  @Test
  public void InsertionDeletionBST() {
    InsertionDeletionBST.main(ARGS);
  }
  ...
  @Test
  public void GrayCodeBacktrack() {
    GrayCodeBacktrack.main(ARGS);
  }
  ...
  @Test
  public void ReverseLinkedListFromSToF() {
    ReverseLinkedListFromSToF.main(ARGS);
  }
