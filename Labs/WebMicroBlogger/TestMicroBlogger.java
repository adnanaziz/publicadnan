...
public class TestMicroBlogger {
    ...
    public static int postingIdCount = 0;  	//used as relative id to account for persistent datastore
    ...
    static ServerMessage doTxRx(List<ClientMessage> cmArray) {
        ...
        try {
            ...
            for (ClientMessage cm : cmArray) {
                ...
                kUrl = new URL(siteURL + queryURL + URLEncoder.encode(cm_json, "utf-8"));
                ...
                InputStream is = kUrl.openStream();
    ...
    private void cleanDataStore() {
        ...
        ClientMessage cmBodyQuery = new ClientMessage()
                .setType(ClientMessage.Type.QUERY).setPageSize(1000);
    ...
    public void testAdd2() {
        ...
        assertEquals(result.getId(), 2 + postingIdCountInit);
        score += 5;
    }
    ...
    public void testTimeRangeQuery1() {
        ...
        ClientMessage cmTimeAndSubjectQuery = new ClientMessage()
                .setType(ClientMessage.Type.QUERY).setDateStart("10:54:32 1/2/2000")
                .setDateEnd("10:54:32 2/28/2000").setSubject("Cruel");

        cleanDataStore();
        postingIdCountInit = postingIdCount;
        
        result = doTxRx(cm1, cm2, cm3, cm4, cm5, cmTimeAndSubjectQuery);
        assertEquals(2, result.getPostings().size());
        assertEquals("LisaHua", result.getPostings().get(0).getAuthor());
        assertEquals(1 + postingIdCountInit, result.getPostings().get(1).getId());
    }
    ...
    public void testStress1() {
        ...
        assertEquals(result.getId(), N - 1 + postingIdCountInit);
        score += 5;
    }
    ...
    public void testUpdate1() {
        ...
        ClientMessage cm2 = new ClientMessage()
                ...
                .setSubject("Second");
        ClientMessage cm3 = new ClientMessage()
                .setType(ClientMessage.Type.UPDATE).setId(0 + postingIdCountInit)
                .setSubject("New First");
        ClientMessage cm4 = new ClientMessage().setType(
                ClientMessage.Type.QUERYBYID).setId(0 + postingIdCountInit);
    ...
    public void testLikes1() {
        ...
        ClientMessage cm3 = new ClientMessage()
                ...
                .setSubject("Third");
        ClientMessage cm4 = new ClientMessage()
                .setType(ClientMessage.Type.LIKE).setId(2 + postingIdCountInit);
        ServerMessage result = doTxRx(cm1, cm2, cm3, cm4);
    ...
    public void testUpvotesAndTrending1() {
        ...
        ClientMessage cm1 = new ClientMessage()
                .setType(ClientMessage.Type.CREATE).setAuthor("AdnanAziz")
                .setSubject("First").setDate("10:04:32 3/5/2000");
        ClientMessage cm2 = new ClientMessage()
                .setType(ClientMessage.Type.CREATE).setAuthor("AngLi")
                .setSubject("Second").setDate("10:24:32 3/5/2000");
        ClientMessage cm3 = new ClientMessage()
                .setType(ClientMessage.Type.CREATE).setAuthor("LisaHua")
                .setSubject("Third").setDate("11:04:32 3/5/2000");
        ClientMessage cm4 = new ClientMessage().setType(
                ClientMessage.Type.UPVOTE).setId(2 + postingIdCountInit);
        ClientMessage cm5 = new ClientMessage().setType(
                ClientMessage.Type.UPVOTE).setId(1 + postingIdCountInit);
    ...
    public void testDelete1() {
        ...
        ClientMessage cm3 = new ClientMessage()
                ...
                .setSubject("Third");
        ClientMessage cm4 = new ClientMessage().setType(
                ClientMessage.Type.DELETE).setId(1 + postingIdCount);
