...
public class BiggestProductNMinus1 {
  ...
  private static void check(List<Integer> A) {
    ...
    if (got != expected) {
        System.err.println("Your program computed the wrong result for input " + A);
  ...
  private static void stressTest() {
    ...
    if (findBiggestProductNMinusOneProduct(A) != 1) {
        System.err.println("Your program computed the wrong result for an array consisting of " + N + " 1s.");
        System.exit(-1);
    }
  }
